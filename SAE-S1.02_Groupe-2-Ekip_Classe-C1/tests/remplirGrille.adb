...
package body remplirGrille is
   ...
   function grille_pleine return Type_Grille is
   begin
      return Remplir_Grille ("grille_pleine.txt");
   end grille_pleine;
   ...
   function Grille_test_masseCase return Type_Grille is
   begin
      return Remplir_Grille ("Grille_test_masseCase.txt");
   end Grille_test_masseCase;
