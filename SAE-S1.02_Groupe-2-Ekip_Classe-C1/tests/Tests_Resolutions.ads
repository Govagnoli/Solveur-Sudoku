...
package tests_Resolutions is
   ...
   function test_Resolution_masseCase_1 return Boolean;
   function test_Resolution_masseCase_2 return Boolean;
   function test_Resolution_masseCase_3 return Boolean;
   ...
   les_Tests : constant array (Positive range <>) of Test_Unitaire :=
     ...
     (test_Resolution_Grille_5'Access,
      ...
      (test_Resolution_masseCase_1'Access,
       To_Unbounded_String ("echec test_Resolution_masseCase_1")),
      (test_Resolution_masseCase_1'Access,
       To_Unbounded_String ("echec test_Resolution_masseCase_2")),
      (test_Resolution_masseCase_1'Access,
       To_Unbounded_String ("echec test_Resolution_masseCase_3")));
