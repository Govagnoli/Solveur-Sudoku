package TAD_Coordonnee is
   ...
   INDEX_CARRE_INVALIDE: exception;
   ...
   -- necessite que l'index numCarre du carre soit un entier entre 1 et 9
   -- leve l'exception INDEX_CARRE_INVALIDE, si l'index numCarre n'est pas compris entre 1 et 9
