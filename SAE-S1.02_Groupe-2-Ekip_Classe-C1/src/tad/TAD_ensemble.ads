package TAD_ensemble is
   ...
   -- Retoure le premier chiffre de l'ensemble e
   -- necessite que l'ensemble e ne soit pas vide
   -- leve l'exception ENSEMBLE_VIDE, si l ensemble e est vide
   function premierChiffre (e : in Type_Ensemble) return Integer;
